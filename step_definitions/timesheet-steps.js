...
Then(
  /^inserts the folowing data into the input fields, Start Date: (.*?), End date: (.*?), Start Time: (.*?), Time Spent: (.*?), Project: (.*?), Module: (.*?), Task: (.*?), Description: (.*?)$/,
  (startDate, endDate, startTime, timeSpent, project, module, task, description) => {
...
Then(
  /^the work log with the following following data, Start Date: (.*?), End date: (.*?), Start Time: (.*?), Time Spent: (.*?), Project: (.*?), Module: (.*?), Task: (.*?), Description: (.*?) should be added$/,
  async (startDate, endDate, startTime, timeSpent, project, _module, task, description) => {
