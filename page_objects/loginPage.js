  ...
  commands: [
    {
      fillLoginCredentials: function(username, password) {
        return this.setValue(cssLib.loginPage.usernameInputField(), username).setValue(
          cssLib.loginPage.passwordInputField(),
          password,
        );
      },
      ...
      logOutFunction: function() {
        return this.waitForElementVisible(cssLib.loginPage.logoutBtn(), 5000).click(cssLib.loginPage.logoutBtn());
      },
    },
  ],
};
